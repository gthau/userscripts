...
const SRC = import.meta.dirname + "/../../src/jira-backlog-sprints.user.js";
...
// Nothing here patches the route, and nothing needs to: `BACKLOG_PATH_RE` is not
// anchored at the start of the path, so a `file://` fixture living in a
// `boards/42/backlog/` directory is a real backlog route as far as the script is
// concerned. The sibling harness for the issue toolbar is not so lucky.
