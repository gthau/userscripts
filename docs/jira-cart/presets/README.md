...
> folded the effort into the ADR. **Regular use was pressed in real Jira on 2026-09-10
> and confirmed good, which closed ADR §7 step 42** — its floor-only, empty-collection
> and two-tab paint bullets accepted unseen and the delete-between guard declined by
> name. `configurability/` is the frozen record of the 1.2.0
